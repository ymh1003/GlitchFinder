...
def compare_npz(npzfile):
    x = load_npz_fast(npzfile)
...
if __name__ == '__main__':
    ...
    for filepath in args.json_files:
        ...
        if result is not None:
            ...
            #data = np.load(result['combined points'], allow_pickle=True)
            #data = load_npz_fast(result['combined points'])
            data = compare_npz(result['combined points'])
